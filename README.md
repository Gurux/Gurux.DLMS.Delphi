...
Gurux.DLMS library is a high-performance Delphi component that helps you to read you DLMS/COSEM compatible electricity, gas or water meters. We have try to make component so easy to use that you do not need understand protocol at all.
...
You can report the [issues](https://www.gurux.fi/project/issues/gurux.dlms.delphi). 
...
You do not necessary need to use Gurux media component like gurux.net.delphi or gurux.serial.delphi 
You can use any connection library you want to.
Gurux.DLMS classes only generate and parse the DLMS data.

You can get [source codes](https://www.github.com/gurux/gurux.dlms.delphi) 
