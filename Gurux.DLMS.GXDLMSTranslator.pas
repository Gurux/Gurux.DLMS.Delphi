...
begin
  ...
  TCommand.GetRequest:
    TGXDLMSLNCommandHandler.HandleGetRequest(settings, value, Nil, xml, TCommand.None);
  TCommand.SetRequest:
    TGXDLMSLNCommandHandler.HandleSetRequest(settings, value, Nil, xml, TCommand.None);
  TCommand.ReadRequest:
    TGXDLMSSNCommandHandler.HandleReadRequest(settings, value, Nil, xml, TCommand.None);
  TCommand.MethodRequest:
    TGXDLMSLNCommandHandler.HandleMethodRequest(settings, value, Nil, xml, TCommand.None);
  TCommand.WriteRequest:
     TGXDLMSSNCommandHandler.HandleWriteRequest(settings, value, Nil, xml, TCommand.None);
  TCommand.AccessRequest:
    TGXDLMSLNCommandHandler.HandleAccessRequest(settings, value, Nil, xml, TCommand.None);
