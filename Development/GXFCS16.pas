...
TGXFCS16 = class
    ...
    class function CountFCS24(buff: TBytes; index: Integer; count: Integer): Word;
end;
...
class function TGXFCS16.CountFCS24(buff: TBytes; index: Integer; count: Integer): Word;
var
  b, i, j: BYTE;
  crcreg : UInt32;
begin
  ...
  begin
      ...
      begin
          crcreg := crcreg shr 1;
          if (b and $80) <> 0 then
              crcreg := crcreg or $80000000;
          if (crcreg and $80) <> 0 Then
              crcreg := crcreg xor CRCPOLY;
          b := b shl 1;
      end;
  end;
  Result := crcreg shr 8;
